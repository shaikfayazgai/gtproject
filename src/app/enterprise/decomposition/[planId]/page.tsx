...
export default function PlanDetailPage() {
  ...
  /* ═══ Gantt Data — 3 Milestones (M1 35%, M2 35%, M3 30%) ═══ */
  const today = new Date();
  const ganttTasks = [
    {
      id: 1,
      text: "M1 — Before Project Starts (35%)",
    ...
    {
      id: 2,
      text: "M2 — Development Closure (35%)",
    ...
    {
      id: 3,
      text: "M3 — UAT Sign-off (30%)",
      start_date: new Date(today.getFullYear(), today.getMonth() + 1, 15),
      duration: 21,
      progress: 0.30,
      type: "milestone",
    },
